...
public class TheGrid2 extends JPanel {

    public TheGrid2() {
        final Color BACKGROUND = Color.getHSBColor(10,300,100);
        final Color[] colors = new Color[]{Color.BLACK, Color.BLACK, Color.BLUE, Color.BLUE};
